    ...
    (function(f) {
      ...
      return (/* @__PURE__ */ function() {
        ...
        113: [function(require2, module3, exports3) {
          "use strict";
          var enumerate = require2("../../enumerate");
          module3.exports = enumerate(["DISPATCH_FRAME_READY", "DISPATCH_FRAME_REPORT"], "frameService:");
        }, {
          "../../enumerate": 99
        }],
          ...
          LegacyFramework.prototype._formatLookupData = function(options) {
            ...
            return BaseFramework.prototype._formatLookupData.call(this, options).then(function(data) {
              if (options.customer && options.customer.billingAddress) {
                data.customer = self2.transformV1CustomerBillingAddress(options.customer);
              }
              return data;
            });
          };
        ...
        137: [function(require2, module3, exports3) {
          ...
          SongbirdFramework.prototype._createPaymentsValidatedCallback = function() {
            ...
            return function(data, validatedJwt) {
              var formattedError;
              analytics.sendEvent(self2._createPromise, "three-d-secure.verification-flow.cardinal-sdk.action-code." + data.ActionCode.toLowerCase());
              if (!self2._verifyCardPromisePlus) {
                self2.handleSongbirdError("cardinal-sdk-setup-error.number-" + data.ErrorNumber);
                return;
              }
              switch (data.ActionCode) {
                ...
                case "FAILURE":
                  ...
                  break;
                case "ERROR":
                  analytics.sendEvent(self2._createPromise, "three-d-secure.verification-flow.cardinal-sdk-error." + data.ErrorNumber);
        ...
        144: [function(require2, module3, exports3) {
          "use strict";
          var basicComponentVerification = require2("../lib/basic-component-verification");
          var createDeferredClient = require2("../lib/create-deferred-client");
          var createAssetsUrl = require2("../lib/create-assets-url");
        ...
        146: [function(require2, module3, exports3) {
          "use strict";
        ...
        150: [function(require2, module3, exports3) {
          "use strict";
          var isAndroid = require2("@braintree/browser-detection/is-android");
          var isChrome = require2("@braintree/browser-detection/is-chrome");
          var isIos = require2("@braintree/browser-detection/is-ios");
        ...
        154: [function(require2, module3, exports3) {
          ...
          function getVenmoUrl(options) {
            if (options.useAllowDesktopWebLogin) return venmoConstants.VENMO_WEB_LOGIN_URL;
            if (options.mobileWebFallBack) return venmoConstants.VENMO_APP_OR_MOBILE_AUTH_URL;
        ...
        156: [function(require2, module3, exports3) {
          ...
          function getElementStyles() {
            var backdropStyles = ["#" + ELEMENT_IDS.backdropHidden + " {", "display: none;", "}", "#" + ELEMENT_IDS.backdrop + " {", "z-index: 3141592632;", "cursor: pointer;", "position: fixed;", "top: 0;", "left: 0;", "bottom: 0;", "width: 100%;", "background: rgba(0, 0, 0, 0.8);", "}"];
            var backdropContainerStyles = ["#" + ELEMENT_IDS.backdropContainer + " {", "display: flex;", "align-content: center;", "justify-content: center;", "align-items: center;", "width: 100%;", "height: 100%;", "flex-direction: column;", "}"];
            var cancelButtonStyles = ["#" + ELEMENT_IDS.cancelButton + " {", "height: 24px;", "width: 380px;", "font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;", "font-style: normal;", "font-weight: 700;", "font-size: 18px;", "line-height: 24px;", "text-align: center;", "background-color: transparent;", "border: none;", "color: #FFFFFF;", "margin-top: 28px;", "}"];
            var continueButtonStyles = ["#" + ELEMENT_IDS.continueButton + " {", "width: 400px;", "height: 50px;", "background: #0074DE;", "border-radius: 24px;", "border: none;", "font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;", "font-style: normal;", "font-weight: 700;", "font-size: 18px;", "color: #FFFFFF;", "margin-top: 44px;", "}"];
            var messageStyles = ["#" + ELEMENT_IDS.message + " {", "font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;", "font-style: normal;", "font-weight: 500;", "font-size: 24px;", "line-height: 32px;", "text-align: center;", "color: #FFFFFF;", "margin-top: 32px;", "}"];
            var instructionStyles = ["#" + ELEMENT_IDS.instructions + " {", "font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;", "font-style: normal;", "font-weight: 400;", "font-size: 16px;", "line-height: 20px;", "text-align: center;", "color: #FFFFFF;", "margin-top: 16px;", "width: 400px;", "}"];
        ...
        203: [function(require2, module3, exports3) {
          ...
          var VAULTED_PAYMENT_METHOD_TYPES_THAT_SHOULD_ALWAYS_BE_HIDDEN = [paymentMethodTypes.applePay, paymentMethodTypes.googlePay, paymentMethodTypes.venmo];
        ...
        204: [function(require2, module3, exports3) {
          ...
          Dropin.prototype._setUpDataCollector = function() {
            var self2 = this;
            var config = assign({}, self2._merchantConfiguration.dataCollector, {
              client: self2._client
            });
        ...
        206: [function(require2, module3, exports3) {
          "use strict";
        ...
        267: [function(require2, module3, exports3) {
          ...
          var HOSTED_FIELDS = ["number", "expirationDate", "cvv", "postalCode", "cardholderName"];
          function CardView() {
            BaseView.apply(this, arguments);
          }
        ...
        268: [function(require2, module3, exports3) {
          (function(global2) {
            (function() {
              "use strict";
              var assign = require2("../../lib/assign").assign;
        ...
        269: [function(require2, module3, exports3) {
          "use strict";
          var paymentOptionIDs = require2("../../constants").paymentOptionIDs;
          var result = {};
        ...
        271: [function(require2, module3, exports3) {
          "use strict";
          var assign = require2("../../lib/assign").assign;
          var paymentOptionIDs = require2("../../constants").paymentOptionIDs;
          var BasePayPalView = require2("./base-paypal-view");
        ...
        272: [function(require2, module3, exports3) {
          "use strict";
          var assign = require2("../../lib/assign").assign;
          var BaseView = require2("../base-view");
          ...
          VenmoView.prototype.initialize = function() {
            var self2 = this;
            var venmoConfiguration = assign({}, self2.model.merchantConfiguration.venmo, {
              client: this.client
            });
...
export default require_dropin();
//# sourceMappingURL=braintree-web-drop-in.js.map
